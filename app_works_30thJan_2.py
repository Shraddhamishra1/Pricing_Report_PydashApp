...
from file_parsers import parse_contents , parse_contents_YT06, parse_contents_YT07 , parse_contents_YT01_805
import os
import pandas as pd
import webbrowser
    ...
    try:
        ...
        if country == "Canada" and report_type in ["YT01 805", "YT01 800", "YT01 611", "YT04 800"]:
            if contents1:
                ...
                raise ValueError("Three files are required for Canada 800, 805, and 611 report types")
        # elif country == "Canada" and report_type in ["YT01 805", "YT01 800", "YT01 611", "YT04 800"]:
        #     if contents1 and contents2 and contents3:
        #         output_div, output_df = parse_contents_YT01_805(contents1, filename1, contents2, filename2, contents3, filename3)
        #         print(f"output_df for YT01 805 Canada: {output_df}")
        #     else:
        #         raise ValueError("Three files are required for Canada 800, 805, and 611 report types")
