...
def update_upload_buttons(country, report_type):
    ...
    if country == 'Malaysia':
        ...
        if report_type == 'YT01 805' or report_type == 'YT01 800' or report_type == 'YT01 611' or report_type == 'YT04 800':  
            label_1 = 'GSAP Data File'
...
def update_progress_bars(contents1, contents2, contents3, report_type, filename1, filename2, filename3):
    ...
    if report_type in ["YT01 800", "YT01 805", "YT01 611", "YT04 800"]:
        print("Report type is YT01 800, YT01 805, YT01 611, YT04 800")
        return (
            progress_values[0],
            upload_status[0]
        )
...
def run_script(n_clicks, contents1, contents2, contents3, contents4, filename1, filename2, filename3, filename4, country, report_type):
    ...
    try:
        ...
        if country == "Malaysia" and report_type == "YT07":
            ...
            if contents1:
                mappingfile_path = r"C:\Users\Shraddha.Mishra\Downloads\mapping_lines_colum_trying.xlsx"
                tpvalue_conditions_path = r"C:\Users\Shraddha.Mishra\Downloads\mapping_lines_colum_trying.xlsx"
                Transferprice_Data_path = r"C:\Users\Shraddha.Mishra\Downloads\Transfer Price Template_New1.xlsx"

                output_div, output_df = parse_contents_YT01_805(contents1, filename1, mappingfile_path, tpvalue_conditions_path, Transferprice_Data_path)
                print(f"output_df for YT01 805 Canada: {output_df}")
            else:
                raise ValueError("One file from UI and three files from local paths are required for Canada 800, 805, and 611 report types")
