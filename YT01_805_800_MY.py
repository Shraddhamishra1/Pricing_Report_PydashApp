...
def generate_dataframe(gs_report_content, gs_report_filename, Mapping_quotation_codes, depot_mapping,Bio_diesel,MY_Historical_values):
    ...
    def process_data(df, map_df):
        ...
        print("Inside process data function in generate df function")
    ...
    # the main code block 
    def final_processing(df, map_df,  depot_df1, bio_diesel, yt_one_sel):
    ...
    def process_materials():
        ...
        for sel in yt_one:
            ...
            replaced_df = final_processing(df, map_df, depot_df1, bio_diesel,sel)
