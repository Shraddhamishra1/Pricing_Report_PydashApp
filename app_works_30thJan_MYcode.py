...
def update_progress_bars(contents1, country, report_type, filename1):
    ...
    if country in ['Malaysia','Canada'] and report_type in ["YT01 805", "YT01 800", "YT01 611", "YT04 800","YT06 807","MY05_YT06","MY05_YT07","MY08_YT06","MY08_YT07","Ethanol CBOB","Ottawa Kingston & Bellev","MY05_YT06","MY08_YT06", "MY05_YT07","MY08_YT07"]:
        return (
            progress_values[0],
            upload_status[0]
        )
...
def run_script(n_clicks, contents1, filename1,country, report_type):
    ...
    try:
        ...
        if country == "Malaysia" and report_type in ["MY05_YT06", "MY05_YT07", "MY08_YT06", "MY08_YT07"]:
            print("Report selected is :", country, report_type)
            if contents1:
                print("in Malaysia and report_type")
                YT06_output_div, MY05_additivecost, MY08_additivecost, ppt_excel = parse_contents_YT06(contents1, filename1)

            tp_template_global = ppt_excel
        ...
        print('1111111111 error of local variable')

        # Update the global variable
        # tp_template_global = tp_template
        print('22222222222 error of local variable')
