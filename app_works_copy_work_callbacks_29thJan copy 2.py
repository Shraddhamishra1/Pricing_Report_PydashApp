...
upload_layout = html.Div([
    ...
    html.Div([
        ...
        # Container for dynamic upload buttons and progress bars
        ...
        # Output container for displaying messages
...
def update_layout(country, report_type):
    if country == 'Malaysia':
        if report_type == 'YT06':
            return [
                html.Div([
                    dcc.Upload(
                        id='upload-data-1',
                        children=html.Div('MY05 Additive Cost', style={'padding': '0 20px', 'font-size': '18px', 'font-weight': 'bold', 'color': 'black'}),
                        style={
                            'flex': '1',
                            'height': '50px',
                            'lineHeight': '50px',
                ...
                html.Div([
                    dcc.Upload(
                        id='upload-data-2',
                        children=html.Div('MY08 Additive Cost', style={'padding': '0 20px', 'font-size': '18px', 'font-weight': 'bold', 'color': 'black'}),
                        style={
                            'flex': '1',
                            'height': '50px',
                            'lineHeight': '50px',
            ...
            return [
                html.Div([
                    dcc.Upload(
                        id='upload-data-1',
                        children=html.Div('MY05 PT Update', style={'padding': '0 20px', 'font-size': '18px', 'font-weight': 'bold', 'color': 'black'}),
                        style={
                            'flex': '1',
                            'height': '50px',
                            'lineHeight': '50px',
                ...
                html.Div([
                    dcc.Upload(
                        id='upload-data-2',
                        children=html.Div('MY08 PT Update', style={'padding': '0 20px', 'font-size': '18px', 'font-weight': 'bold', 'color': 'black'}),
                        style={
                            'flex': '1',
                            'height': '50px',
                            'lineHeight': '50px',
            ...
            return [
                html.Div([
                    dcc.Upload(
                        id='upload-data-1',
                        children=html.Div('Upload TP File', style={'padding': '0 20px', 'font-size': '18px', 'font-weight': 'bold', 'color': 'black'}),
                        style={
                            'flex': '1',
                            'height': '50px',
                            'lineHeight': '50px',
                ...
                html.Div([
                    dcc.Upload(
                        id='upload-data-2',
                        children=html.Div('Quotation Codes Mapping', style={'padding': '0 20px', 'font-size': '18px', 'font-weight': 'bold', 'color': 'black'}),
                        style={
                            'flex': '1',
                            'height': '50px',
                            'lineHeight': '50px',
        ...
        return [
            html.Div([
                dcc.Upload(
                    id='upload-data-1',
                    children=html.Div('GSAP File', style={'padding': '0 20px', 'font-size': '18px', 'font-weight': 'bold', 'color': 'black'}),
                    style={
                        'flex': '1',
                        'height': '50px',
                        'lineHeight': '50px',
...
def update_progress_bars(contents1, contents2, contents3, country, report_type, filename1, filename2, filename3):
    print(f"update_progress_bars called with contents1={contents1}, contents2={contents2}, contents3={contents3}, country={country}, report_type={report_type}")
    ...
    if country == 'Canada' and report_type in ['YT01 800', 'YT01 805', 'YT01 611', 'YT04 800']:
        print("Country is Canada and report type is one of YT01 800, YT01 805, YT01 611, YT04 800")
        return (
            progress_values[0], 0, 0,
            upload_status[0], 'Not Uploaded', 'Not Uploaded'
        )
    elif country == 'Malaysia' and report_type in ['YT06', 'YT07']:
        print("Country is Malaysia and report type is YT06 or YT07")
        return (
            progress_values[0], progress_values[1], 0,
            upload_status[0], upload_status[1], 'Not Uploaded'
        )
    elif country == 'Malaysia' and report_type in ['YT01 800', 'YT01 805', 'YT01 611', 'YT04 800']:
        print("Country is Malaysia and report type is one of YT01 800, YT01 805, YT01 611, YT04 800")
        return (
...
def update_output(contents1, contents2, contents3, filename1, filename2, filename3, country, report_type):
    if country == 'Canada' and report_type in ['YT01 800', 'YT01 805', 'YT01 611', 'YT04 800']:
        return update_progress_bars(contents1, None, None, country, report_type, filename1, None, None)
    elif country == 'Malaysia' and report_type in ['YT06', 'YT07']:
        return update_progress_bars(contents1, contents2, None, country, report_type, filename1, filename2, None)
    elif country == 'Malaysia' and report_type in ['YT01 800', 'YT01 805', 'YT01 611', 'YT04 800']:
        return update_progress_bars(contents1, contents2, contents3, country, report_type, filename1, filename2, filename3)
    else:
        return 0, 'Not Uploaded', 0, 'Not Uploaded', 0, 'Not Uploaded'
# old working code
# upload_layout = html.Div([
#     navbar,
#     html.Div([
...
#     if country == 'Canada' and report_type in ["YT01 805", "YT01 800", "YT01 611", "YT04 800"]:
#         print("Country is Canada and report type is one of YT01 805, YT01 800, YT01 611, YT04 800")
#         return (
#             progress_values[0], 0, 0,
#             upload_status[0], 'Not Uploaded', 'Not Uploaded'
#         )
...
#         print("Country is Malaysia and report type is one of YT01 800, YT01 805, YT01 600")
#         return (
#             progress_values[0], progress_values[1], progress_values[2],
#             upload_status[0], upload_status[1], upload_status[2]
#         )
...
def run_script(n_clicks, contents1, contents2, contents3, contents4, filename1, filename2, filename3, filename4, country, report_type):
    ...
    try:
        ...
        elif country == "Canada" and report_type in ["YT01 805", "YT01 800", "YT01 611", "YT04 800"]:
            if contents1 and contents2 and contents3 and contents4:
                ...
                raise ValueError("Four files are required for Canada 800, 805, and 611 report types")
